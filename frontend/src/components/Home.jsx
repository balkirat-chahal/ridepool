      ...
      <div className="mt-10 w-full max-w-6xl space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#ffedd5] shadow-lg rounded-2xl p-6 flex flex-col">
            ...
            <input type="text" placeholder="From" className="w-full p-2 mb-2 border rounded-md bg-white" />
            <input type="text" placeholder="To" className="w-full p-2 mb-2 border rounded-md bg-white" />
            <div className="relative mb-4">
              <CalendarToday className="absolute left-3 top-3 text-gray-400" />
              <input type="date" className="w-full p-2 pl-10 border rounded-md bg-white" />
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#d1fae5] shadow-lg rounded-2xl p-6 flex flex-col">
            ...
            <button className="w-full bg-green-600 hover:bg-green-700 text-white rounded-lg py-2">
              Post your ride
            </button>
          </div>
        </div>
